...
export const metadata: Metadata = {
  ...
  description:
    'Tiger Framework is an open-source full-stack meta-framework powered by Tiger CLI. Scaffold FastAPI or Express backends, PostgreSQL/MySQL databases, and Next.js 14 frontends with 3D Glassmorphism, automated Git pipelines, and AI copilot in seconds. Proudly backed by x010.tech.',
  keywords: [
    'Tiger Framework',
    'Tiger CLI',
  ...
  openGraph: {
    ...
    description:
      'High-velocity full-stack meta-framework with FastAPI/Express, PostgreSQL, Next.js 14, 3D Glassmorphic UI Kit, and autonomous Git tools. Powered by x010.tech.',
    images: [
      {
        url: '/logo.png',
        width: 800,
  ...
  twitter: {
    ...
    description:
      'Scaffold full-stack FastAPI/Next.js 14 apps with 3D Glassmorphism, database migrations, and autonomous Git push in under 2 seconds. Powered by x010.tech.',
    images: ['/logo.png'],
    creator: '@x010tech',
  },
  icons: {
    ...
    '@graph': [
      {
        ...
        description:
          'Command-line based full-stack meta-framework for scaffolding FastAPI/Express backends, Next.js 14 frontends with 3D Glassmorphism, and database migrations.',
        url: 'https://tiger-framework.org',
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Tiger Framework is an open-source full-stack meta-framework created by x010.tech and IAR-010. It integrates FastAPI or Express backends with Next.js 14 App Router, PostgreSQL/MySQL/SQLite databases, Alembic migrations, and a hardware-accelerated 3D Glassmorphic UI library into a single CLI toolchain.',
            },
          },
          {
            '@type': 'Question',
